...
return [
    ...
    'ACCOUNT' => [
        'ACTIVITY' => [
            'CREATE'                  => 'Compte créé for <strong>{{subject.full_name}}</strong>',
            'DELETE'                  => 'Compte supprimé',
            'UPDATE_INFO'             => 'Informations du compte mises à jour',
            'ADD_TO_GROUP'            => 'Compte ajouté au groupe <strong>{{context.name}}</strong>',
            'REMOVE_FROM_GROUP'       => 'Compte retiré du groupe <strong>{{context.name}}</strong>',
            'UPDATE_ROLES'            => 'Rôles du compte ajoutés : <strong>{{added_roles}}</strong> ; supprimés : <strong>{{removed_roles}}</strong>',
            'UPDATE_FIELD'            => 'Champ du compte {{field}} mis à jour',
            'ENABLE'                  => 'Compte activé',
            'DISABLE'                 => 'Compte désactivé',
            'VERIFY'                  => 'Compte vérifié',
            'UNVERIFY'                => 'Compte non vérifié',
            ...
            'LABEL' => [
                ...
                'ADD_TO_GROUP'            => 'Compte ajouté au groupe',
                'REMOVE_FROM_GROUP'       => 'Compte retiré du groupe',
                'UPDATE_ROLES'            => 'Rôles du compte modifiés',
