...
return [
    ...
    'ACCOUNT' => [
        'ACTIVITY' => [
            'CREATE'                  => 'Account created for <strong>{{subject.full_name}}</strong>',
            'DELETE'                  => 'Account deleted',
            'UPDATE_INFO'             => 'Account information updated',
            'ADD_TO_GROUP'            => 'Account added to group <strong>{{context.name}}</strong>',
            'REMOVE_FROM_GROUP'       => 'Account removed from group <strong>{{context.name}}</strong>',
            'UPDATE_ROLES'            => 'Account roles added: <strong>{{added_roles}}</strong>; removed: <strong>{{removed_roles}}</strong>',
            'UPDATE_FIELD'            => 'Account field {{field}} updated',
            'ENABLE'                  => 'Account enabled',
            'DISABLE'                 => 'Account disabled',
            'VERIFY'                  => 'Account verified',
            'UNVERIFY'                => 'Account unverified',
            ...
            'LABEL' => [
                ...
                'UPDATE_ROLES'            => 'Account roles changed',
